...
# Owner: https://github.com/UnknownX7/DalamudPluginRepo/blob/master/generate_pluginmaster.py
...
def add_extra_fields(manifests):
    for manifest in manifests:
        ...
        manifest['DownloadCount'] = get_release_download_count('Catphinaud', manifest["InternalName"], manifest['AssemblyVersion'])
